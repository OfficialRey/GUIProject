...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        for i in range(100):
            ...
            stock_table.setCellWidget(i, 0, QtWidgets.QLabel("Stock" + str(i)))
            stock_table.setCellWidget(i, 1, QtWidgets.QLabel(str(i)))
            stock_table.setCellWidget(i, 2, QtWidgets.QLabel("+0.00%"))
